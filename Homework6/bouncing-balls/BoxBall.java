 ...
 * will fall downwards, accelerating with time due to the effect of gravity, and bouncing
 * when hitting the ground or the walls.
 *
...
public class BoxBall
{
    ...
    public void move()
    {
        ...
        if(xPosition <= leftWallPos || xPosition >= (rightWallPos - diameter)){
            xSpeed *= -1;
        }
        if(yPosition <= 100){
            ySpeed *= -1;
